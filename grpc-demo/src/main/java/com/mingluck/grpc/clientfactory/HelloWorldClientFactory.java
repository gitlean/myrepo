package com.mingluck.grpc.clientfactory;
...
import com.mingluck.grpc.client.HelloWorldClient;

/**
*@author anonymous
*@createTime 2019年10月23日 上午10:10:22
*@describe 为了防止客户端不断调用带来的开销(短连接)，下面的例子给出了连接池的方式          client并发调度
*/
