...
create table QUARTZ_JOBS(
	id vrachar(50),
	job_name vrachar(100),
	job_type vrachar(100),
	trigger_name vrachar(100),
	trigger_type vrachar(100),
	cron_expr vrachar(20),
	name vrachar(50),
	runtime_last date,
	runtime_next date,
	job_status vrachar(2),
	run_times int,
	run_duration int
	sync_start_date date,
	sync_end_date date,
	job_class  vrachar(50),
	job_method vrachar(50),
	create_by vrachar(50),
	create_date date
	version vrachar(8),
);
