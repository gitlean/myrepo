 ...
 */
@Component
public class ProductAwareBeanprocessor implements BeanPostProcessor,
	...
	public void setApplicationContext(ApplicationContext context)
		...
		ProductAwareBeanprocessor.context = context;// 静态变量等于形参
													// ,这里不能用this.context =
													// context
	...
	public Object postProcessBeforeInitialization(Object bean, String beanName)
		...
		for (ProductAwareBean productAware : context.getBeansOfType(
				ProductAwareBean.class).values()) {
			// 这里可以根据条件判断是否执行以下代码,例如productId
			// if(productAware.getProductId().equals(productId)){}

			replaceableBeanNames.putAll(productAware
					.getReplaceableBeanNameRigistry());
