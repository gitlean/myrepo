...
<body align="center">
	...
	<p align="center">echarts-map9</p>
	<br />
	<!-- 建立一个有高度和宽度的dom(建议div) -->

	<div id="mainMap" align="center" style="width: 1000px; height: 800px"></div>
	<p>----------------------------------------------------------------------------------------------------------------------------------</p>
	<div id="provinceMap" align="center" style="width: 1000px; height: 800px"></div>
...
<script type="text/javascript">
	...
	function showProvince(pName){
		...
		$.get(mapName, function(mapJson) { //请求 "map/shandong.json"  返回数据 mapJson
			...
			var chart = echarts.init(document.getElementById('provinceMap'));//在id为mainMap的dom元素中显示地图
